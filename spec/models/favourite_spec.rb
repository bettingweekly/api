...
RSpec.describe Favourite, type: :model do
  describe '#create' do
    ...
    context 'errors' do
      ...
      it 'should raise an error if the number
          is greater than the limit 100000000000' do
        favourite = Favourite.create(number: 200_000_000_000)
        expect(favourite.valid?).to be_falsey
        expect(favourite.errors[:number][0]).to eq 'must be less than or equal to 100_000_000_000'
      end
